...
<div class="container py-5">
    <div class="bg-white shadow rounded p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0 fw-semibold">Lista de Funcionários</h2>
    ...
    @endif
        ...
        <div class="table-responsive">
            <table id="funcionarios-table" class="table table-striped table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ route('funcionarios.edit', $funcionario->id) }}" class="btn btn-sm btn-outline-warning me-1">
